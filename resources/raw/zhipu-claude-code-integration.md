...
<Tip>
  ...
  * `ANTHROPIC_DEFAULT_HAIKU_MODEL`：`GLM-4.5-Air`
  ...
  GLM-5.1/GLM-5-Turbo 作为高阶模型，对标 Claude Opus， 调用时将按照 “高峰期 3 倍，非高峰期 2 倍” 系数消耗额度。

  作为限时福利，GLM-5.1/GLM-5-Turbo 将在非高峰期仅作为 1 倍抵扣，持续到 4 月底。注：“高峰期”为每日的 14:00～18:00 （UTC+8）。
</Tip>
